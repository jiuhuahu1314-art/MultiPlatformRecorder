...
namespace BililiveRecorder.Core.Config.V3
{
    ...
    public sealed partial class RoomConfig : HierarchicalObject<GlobalConfig, RoomConfig>
    {
        ...
        /// 直播平台
        /// </summary>
        public string? Platform { get => this.GetPropertyValue<string>(); set => this.SetPropertyValue(value); }
        public bool HasPlatform { get => this.GetPropertyHasValue(nameof(this.Platform)); set => this.SetPropertyHasValue<string>(value, nameof(this.Platform)); }
        [JsonProperty(nameof(Platform)), EditorBrowsable(EditorBrowsableState.Never)]
        public Optional<string?> OptionalPlatform { get => this.GetPropertyValueOptional<string>(nameof(this.Platform)); set => this.SetPropertyValueOptional(value, nameof(this.Platform)); }

        /// <summary>
        /// 直播间原始链接
        /// </summary>
        public string? RoomUrl { get => this.GetPropertyValue<string>(); set => this.SetPropertyValue(value); }
        public bool HasRoomUrl { get => this.GetPropertyHasValue(nameof(this.RoomUrl)); set => this.SetPropertyHasValue<string>(value, nameof(this.RoomUrl)); }
        [JsonProperty(nameof(RoomUrl)), EditorBrowsable(EditorBrowsableState.Never)]
        public Optional<string?> OptionalRoomUrl { get => this.GetPropertyValueOptional<string>(nameof(this.RoomUrl)); set => this.SetPropertyValueOptional(value, nameof(this.RoomUrl)); }
        ...
        /// 开机自启
        /// </summary>
        public bool WpfAutoStart => this.GetPropertyValue<bool>();
    ...
    public sealed partial class GlobalConfig : HierarchicalObject<DefaultConfig, GlobalConfig>
    {
        ...
        /// 开机自启
        /// </summary>
        public bool WpfAutoStart { get => this.GetPropertyValue<bool>(); set => this.SetPropertyValue(value); }
        public bool HasWpfAutoStart { get => this.GetPropertyHasValue(nameof(this.WpfAutoStart)); set => this.SetPropertyHasValue<bool>(value, nameof(this.WpfAutoStart)); }
        [JsonProperty(nameof(WpfAutoStart)), EditorBrowsable(EditorBrowsableState.Never)]
        public Optional<bool> OptionalWpfAutoStart { get => this.GetPropertyValueOptional<bool>(nameof(this.WpfAutoStart)); set => this.SetPropertyValueOptional(value, nameof(this.WpfAutoStart)); }
    ...
    public sealed partial class DefaultConfig
    {
        ...
        public bool WpfAutoStart => false;
