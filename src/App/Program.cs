...
namespace BililiveRecorder.WPF
{
    internal static class Program
    {
        ...
        private static RootCommand BuildCommand()
        {
            ...
            root.Handler = CommandHandler.Create<bool, SemanticVersion?, SemanticVersion?, SemanticVersion?, SemanticVersion?, bool>(Commands.RunRootCommandHandler);
            return root;
        }
        ...
        private static class Commands
        {
            ...
            internal static int RunRootCommandHandler(bool squirrelFirstrun, SemanticVersion? squirrelInstall, SemanticVersion? squirrelUpdated, SemanticVersion? squirrelObsolete, SemanticVersion? squirrelUninstall, bool hide = false)
            {
                ...
                else
                {
                    ...
                    return RunWpfHandler(path: null, squirrelFirstrun: squirrelFirstrun, askPath: false, hide: hide);
                }
            }
